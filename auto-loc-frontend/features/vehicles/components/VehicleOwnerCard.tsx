...
import {
  ...
  CalendarDays, UserCheck, AlertTriangle, Shield, Loader2, Lock
} from 'lucide-react';
              ...
              <div className="space-y-2 pl-8 pt-1 animate-in slide-in-from-top-2 duration-300">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Adresse exacte (ex: Almadies, Dakar)"
                ...
                {!deliveryAddress.trim() && (
                  <div className="flex items-center gap-1.5 text-amber-600">
                    ...
                    <p className="text-[11.5px] font-bold">Veuillez indiquer l&apos;adresse</p>
                  </div>
                )}
              </div>
            )}
