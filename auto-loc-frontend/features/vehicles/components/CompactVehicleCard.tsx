...
/**
 * Carte véhicule compacte (photo + badge note + nom + ville + prix), pensée pour
 * les grilles 2 colonnes mobile. Utilisée par PremiumSelectionGrid et la grille /explorer.
 */
