...
export function RecentReservations({
  ...
  const ReservationRow = ({ reservation }: { reservation: ReservationItem }) => {
    ...
    return (
      <div className="group flex items-center gap-4 rounded-lg border border-[hsl(var(--border))] p-4 transition-all duration-200 hover:shadow-sm hover:border-foreground/20">
        {/* Icon */}
  ...
  return (
    <div className="rounded-lg border border-[hsl(var(--border))] bg-card shadow-sm">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-[hsl(var(--border))]">
        <h3 className="text-xl font-bold">{effectiveTitle}</h3>
        <Link
