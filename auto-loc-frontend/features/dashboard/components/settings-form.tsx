                        ...
                        profile.role === 'PROPRIETAIRE' ? (
                            <div className="flex items-center gap-2 flex-wrap">
                                <Link
                                    ...
                                    className="flex items-center gap-1.5 text-[12px] font-bold text-emerald-700 bg-emerald-100 hover:bg-emerald-200 px-3 py-1.5 rounded-lg transition-colors"
                                >
                                ...
                                <button
                                    ...
                                    disabled={switching}
                                    className="flex items-center gap-1 text-[11px] font-semibold text-slate-500 bg-slate-100 hover:bg-slate-200 px-2 py-1.5 rounded-lg transition-colors disabled:opacity-50"
                                >
                                    {switchingToTenant
