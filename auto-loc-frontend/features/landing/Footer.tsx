...
const FOOTER_LINKS = {
  ...
  zones: [
    { label: 'Almadies – Ngor – Mamelles', href: '/location/almadies-ngor-mamelles' },
    { label: 'Ouakam – Yoff', href: '/location/ouakam-yoff' },
    { label: 'Mermoz – Sacré-Cœur – Cité Keur Gorgui', href: '/location/mermoz-sacrecoeur-ckg' },
    { label: 'Plateau – Médina – Gueule Tapée', href: '/location/plateau-medina-gueuletapee' },
    { label: 'Liberté – Sicap – Grand Dakar', href: '/location/liberte-sicap-granddakar' },
    { label: 'Parcelles Assainies – Grand Yoff', href: '/location/parcelles-grandyoff' },
    { label: 'Pikine – Guédiawaye', href: '/location/pikine-guediawaye' },
    { label: 'Keur Massar – Rufisque', href: '/location/keurmassar-rufisque' },
  ],
  legal: [
