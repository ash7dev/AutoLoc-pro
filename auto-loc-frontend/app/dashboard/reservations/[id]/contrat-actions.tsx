...
export function ContratActions({ reservationId, canPrint, dateDebut, from, showPdf = true }: ContratActionsProps) {
    ...
    const voirHref = `/dashboard/reservations/${reservationId}/contrat${from ? `?from=${from}` : ''}`;
