    ...
    <div className="space-y-4 text-left animate-in fade-in duration-200">
      ...
      <div className="flex flex-col items-center text-center space-y-2">
        <div className="w-14 h-14 rounded-full bg-[#ECFDF5] border border-[#A7F3D0] flex items-center justify-center shadow-sm">
          <Smartphone className="w-7 h-7 text-[#059669] stroke-[2.2]" />
        </div>

        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#ECFDF5] border border-[#A7F3D0] text-[#059669] text-[9px] font-medium tracking-wider uppercase">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1 max-w-[280px] mx-auto leading-relaxed">
            ...
            <span className="font-medium text-[#059669]">{telephone || '+221 77 000 00 00'}</span>
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleFormSubmit} className="space-y-4 pt-1">
            ...
            return (
              <input
                ...
                className={`w-9 h-11 sm:w-11 sm:h-13 text-center text-lg sm:text-xl font-bold rounded-xl border transition-all outline-none ${
                  hasValue
                    ? 'border-[#059669] bg-emerald-50/40 text-[#041912] shadow-sm'
                    : isFocused
        ...
        <button
          ...
          className="w-full h-[50px] rounded-full bg-[#041912] hover:bg-[#06291e] text-white font-medium text-xs sm:text-sm flex items-center justify-center gap-2 shadow-lg shadow-[#041912]/20 transition-all active:scale-[0.99] disabled:opacity-50 mt-2"
        >
          {isLoading ? (
        ...
        {countdown > 0 ? (
          <div className="space-y-1">
            <p className="text-xs text-slate-500">
              Renvoyer un nouveau code dans <span className="font-medium text-[#059669]">{countdown}s</span>
            </p>
            <button
              type="button"
          ...
          <div className="flex items-center justify-center gap-3 text-xs font-medium">
            <button
              ...
              disabled={isResending}
              className="inline-flex items-center gap-1.5 text-[#059669] hover:underline"
            >
