...
export const PrivacyHeroSection: React.FC = () => {
  return (
    <section className="relative overflow-hidden rounded-3xl bg-brand-dark text-white shadow-xl">
      {/* Halos décoratifs */}
      <div className="pointer-events-none absolute -top-32 -left-32 h-[500px] w-[500px] rounded-full bg-emerald-400/8 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-24 right-0 h-80 w-80 rounded-full bg-champagne/5 blur-3xl" />
      ...
      <div className="relative z-10 px-6 py-10 sm:px-10 sm:py-14 lg:px-14 lg:py-16">
        ...
        <div className="max-w-2xl space-y-5">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-champagne/20 bg-champagne/8 px-4 py-1.5">
            <Lock className="h-3.5 w-3.5 text-champagne" strokeWidth={2} />
