    ...
    <section className="relative overflow-hidden rounded-3xl bg-brand-dark text-white shadow-xl">
      ...
      <div className="relative z-10 px-6 py-12 sm:px-10 sm:py-16 lg:px-14 lg:py-20 text-center">
        <div className="mx-auto max-w-2xl space-y-5">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-brand-main ring-4 ring-champagne/10 mx-auto shadow-lg">
            <Headphones className="h-7 w-7 text-champagne" />
          </div>
