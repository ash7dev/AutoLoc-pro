...
import { Search, Scale, RefreshCw, Car } from 'lucide-react';

interface AdminDisputeHeaderBarProps {
  statut: string;
...
export const AdminDisputeHeaderBar: React.FC<AdminDisputeHeaderBarProps> = ({
  statut,
  onStatutChange,
  search,
  onSearchChange,
  ...
  const tabs = [
    { id: 'EN_ATTENTE', label: 'En attente', count: counts?.pending ?? 0, tone: GOLD, bg: 'rgba(178, 124, 45, 0.1)' },
    { id: 'FONDE', label: 'Fondés (Locataire)', count: counts?.fonde ?? 0, tone: FOREST, bg: 'rgba(10, 61, 46, 0.08)' },
    { id: 'NON_FONDE', label: 'Non fondés (Hôte)', count: counts?.nonFonde ?? 0, tone: RUST, bg: 'rgba(161, 61, 61, 0.1)' },
    { id: 'ALL', label: 'Tous les litiges', count: counts?.total ?? 0, tone: SLATE, bg: 'rgba(74, 95, 117, 0.1)' },
  ];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-xl font-normal text-brand-dark dark:text-white">Gestion des Litiges</h1>
            ...
            <p className="text-xs font-normal text-slate-500 dark:text-slate-400 mt-0.5">
              Traitement des réclamations, conciliation financière et réquisition des preuves
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span>Passer aux véhicules</span>
          </Link>
      ...
      <div className="p-2 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/70 dark:border-slate-800 shadow-xs flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        ...
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            placeholder="Motif, Locataire, Hôte, Véhicule, Plaque..."
