...
export interface TenantSecuritySettingsCardProps {
  profile: UserProfileData;
  onOpenDeleteAccountModal: () => void;
}

export const TenantSecuritySettingsCard: React.FC<TenantSecuritySettingsCardProps> = ({
  profile,
    ...
    <div className="rounded-3xl border border-[#041912]/8 bg-white p-6 sm:p-8 shadow-xs">
      ...
      <div className="mt-6 border-t border-slate-100 pt-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="shrink-0 rounded-xl border border-slate-200 px-4 py-2 text-[12.5px] font-semibold text-slate-700 transition-colors hover:border-slate-300 hover:bg-slate-50 cursor-pointer sm:w-auto"
          >
          ...
          <form onSubmit={handleChangeEmail} className="mt-4 space-y-4 border-t border-slate-100 pt-4">
            ...
            <div className="flex justify-end gap-2.5 pt-1">
              <button
                ...
                className="rounded-xl px-4 py-2 text-[12.5px] font-medium text-slate-500 hover:text-slate-700 cursor-pointer"
              >
                Annuler
              </button>
              <button
      ...
      <div className="mt-5 flex flex-col gap-3 border-t border-slate-100 pt-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl border border-slate-200 px-4 py-2 text-[12.5px] font-semibold text-slate-700 transition-colors hover:border-slate-300 hover:bg-slate-50 disabled:opacity-50 cursor-pointer sm:w-auto"
        >
      ...
      {/* Zone de danger */}
      <div className="mt-6 rounded-2xl bg-rose-50/60 p-5 border border-rose-100">
        <div className="flex items-center gap-3">
        ...
        <div className="mt-4 flex flex-col gap-3.5 sm:flex-row sm:items-center sm:justify-between">
          <p className="max-w-xl text-[12.5px] leading-relaxed text-rose-800">
            La suppression de votre compte entraîne la suppression définitive de votre historique de réservations, vos données d'identité ainsi que la fermeture de vos accès.
          </p>

          <button
            type="button"
            onClick={onOpenDeleteAccountModal}
            className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-rose-600 px-4 py-2.5 text-[12.5px] font-semibold text-white transition-colors hover:bg-rose-700 cursor-pointer shadow-xs"
          >
