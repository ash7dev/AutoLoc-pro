...
export interface TenantDeleteAccountModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const TenantDeleteAccountModal: React.FC<TenantDeleteAccountModalProps> = ({
  isOpen,
  onClose,
}) => {
      ...
      <div className="relative w-full max-w-lg overflow-hidden rounded-3xl bg-white shadow-2xl border border-rose-100 p-6 sm:p-8 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-fraunces text-xl font-bold text-rose-950">
                Suppression du Compte Locataire
              </h3>
        ...
        <div className="p-4 rounded-2xl bg-rose-50 border border-rose-200/80 text-rose-900 text-xs sm:text-sm leading-relaxed space-y-2">
          ...
          <ul className="list-disc pl-4 space-y-1 text-xs text-rose-800">
            <li>Votre historique complet de réservations et factures sera clôturé.</li>
            <li>Vos documents KYC d'identité et de permis seront purgés.</li>
            <li>Cette action entraînera la perte définitive de votre compte membre AutoLoc.</li>
          </ul>
        </div>
