...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative min-h-0 lg:min-h-[85vh] bg-[#F8FAF4] text-slate-900 pt-[calc(8.5rem+env(safe-area-inset-top))] sm:pt-28 pb-3 sm:pb-12 overflow-hidden">
