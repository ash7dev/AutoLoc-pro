 ...
 *
 * Typographie : Gloock pour le titre et le prix (voir note d'installation),
 * sans-serif du projet pour le reste.
 */
const SERIF = "var(--font-gloock), var(--font-fraunces), Georgia, serif";

export const FeaturedVehicleCard: React.FC<FeaturedVehicleCardProps> = ({ vehicle }) => {
