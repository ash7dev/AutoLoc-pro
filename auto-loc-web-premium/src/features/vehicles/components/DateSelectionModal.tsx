      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100 bg-slate-50/50">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-[#0A3D2E] text-[#F1DFB6] flex items-center justify-center shadow-sm">
              <Calendar className="w-5 h-5" />
            </div>
            <div>
              <h3 
                className="text-lg font-normal text-[#041912] font-fraunces tracking-tight"
        ...
        <div className="p-6 overflow-y-auto space-y-4">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 flex items-center justify-between text-xs">
            ...
            {daysCount > 0 && (
              <span className="px-3 py-1 rounded-full bg-[#0A3D2E] text-[#F1DFB6] font-bold text-xs">
        ...
        <div className="px-6 py-4 border-t border-slate-100 bg-slate-50/50 flex items-center justify-end gap-3">
          ...
          <button
            ...
            onClick={onClose}
            disabled={!startDate}
            className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-[#0A3D2E] hover:bg-[#0F4F3B] disabled:opacity-50 text-[#F1DFB6] font-semibold text-xs transition-all shadow-md cursor-pointer"
          >
