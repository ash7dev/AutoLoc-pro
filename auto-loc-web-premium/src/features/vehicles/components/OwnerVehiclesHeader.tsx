      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <div className="min-w-0 space-y-3">
          <h1 className="font-fraunces text-3xl leading-[1.1] tracking-tight text-brand-dark sm:text-4xl lg:text-5xl">
            Gestion de votre <span className="text-brand-main">parc automobile</span>
          </h1>
        ...
        <div className="flex shrink-0 items-center gap-2.5 pt-1 lg:pt-0">
          ...
          {onAddVehicle && (
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-brand-dark px-5 py-2.5 text-[13px] font-semibold text-champagne transition-colors hover:bg-brand-main"
            >
