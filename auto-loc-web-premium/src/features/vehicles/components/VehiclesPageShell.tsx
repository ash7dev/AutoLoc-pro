...
export const VehiclesPageShell: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#F8FAF4] pt-[calc(7rem+env(safe-area-inset-top))] md:pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-x-hidden">
