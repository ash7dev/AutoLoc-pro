        ...
        <View style={styles.frontGlassCard}>
          ...
          <View style={styles.cardHeaderBox}>
            <View style={styles.iconWrapper}>
              <Car size={32} color="#059669" strokeWidth={2.2} />
            </View>

            <View style={styles.badgeKycGlass}>
              <ShieldCheck size={12} color="#059669" />
              <Text style={styles.badgeKycText}>ESPACE PROPRIÉTAIRE</Text>
            </View>
          ...
          <View style={styles.timeEstimateCard}>
            ...
            <Text style={styles.timeEstimateText}>
              Temps estimé : <Text style={styles.timeBold}>~2 minutes</Text> • Une seule fois pour publier vos annonces
            </Text>
          </View>

          {/* Checklist des Étapes Restantes */}
          <View style={styles.stepsCard}>
            <Text style={styles.stepsSectionTitle}>Checklist de vérification hôte :</Text>
