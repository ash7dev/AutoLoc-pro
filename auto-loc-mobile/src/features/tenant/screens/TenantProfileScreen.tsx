  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
            ...
            if (updatedProfile) {
              ...
              if (missing.length > 0) {
                Alert.alert(
                  ...
                  'Vos informations ont été enregistrées. Une vérification d’identité (KYC) est nécessaire pour débloquer les réservations.',
                  [
        ...
        <View style={styles.assistance}>
          ...
          <View style={styles.assistanceText}>
            ...
            <Text style={styles.assistanceDescription}>Notre équipe AutoLoc est disponible pour vous accompagner.</Text>
          </View>
        </View>
        <AutoButton
      ...
      <ReservationGateModal
        visible={gateVisible}
        vehicleTitle="Votre compte AutoLoc"
