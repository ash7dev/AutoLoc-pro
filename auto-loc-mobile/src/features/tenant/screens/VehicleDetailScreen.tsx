    ...
    <View style={styles.rootContainer}>
      ...
      <BookingCheckoutModal
        ...
        vehicle={{
          ...
          proposeLivraisonDakar: detail?.proposeLivraisonDakar,
          fraisLivraisonDakar: detail?.fraisLivraisonDakar ? Number(detail.fraisLivraisonDakar) : undefined,
          proposeLivraisonAibd: detail?.proposeLivraisonAibd,
          fraisLivraisonAibd: detail?.fraisLivraisonAibd ? Number(detail.fraisLivraisonAibd) : undefined,
